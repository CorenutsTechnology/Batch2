package com.crnt.WebApplication.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "com.crnt.WebApplication";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/WebApplication-model"),
        mapper("/WebApplication-dao"),
        mapperxml("/WebApplication-web"),
        service("/WebApplication-service"),
