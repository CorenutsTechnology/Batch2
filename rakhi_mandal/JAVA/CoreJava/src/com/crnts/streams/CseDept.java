...
public class CseDept {
	...
	public static void main(String[] args) {
		...
		listStudents.add(new Student(9,"shreya","female","cse","ameerpeth","hyd","telangana"));
		...
		List result=listStudents.stream().filter((e)->e.getDepartment().equals("cse")).collect(Collectors.toList());
